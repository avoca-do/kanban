...
final class FilterTests: XCTestCase {
    ...
    func testContent() {
        ...
        board[content: .card(.column(.archive, 0), 0)] = "total recall"
        board[content: .card(.column(.archive, 0), 0)] = "lorem ipsum"
        XCTAssertEqual("lorem ipsum", board[content: .card(.column(.archive, 0), 0)])
    ...
    func testHorizontal() {
        ...
        XCTAssertEqual(1, board[.column(.archive, 2)].count)
        XCTAssertEqual(3, board.snaps.first!.state.actions.count)
    }
    ...
    func testHorizontalRedundant() {
        ...
        XCTAssertEqual(0, board[.card(.column(.archive, 0), 0)][.card(.column(.archive, 0), 0)].id)
    ...
    func testHorizontalRedundantUpdate() {
        ...
        board.move(.card(.column(.archive, 1), 0), horizontal: 0)
        board.move(.card(.column(.archive, 0), 0), horizontal: 1)
        XCTAssertEqual(0, board[.card(.column(.archive, 1), 0)][.card(.column(.archive, 1), 0)].id)
        XCTAssertTrue(board.snaps.last!.state.actions.isEmpty)
    }
    ...
    func testVertical() {
        ...
        XCTAssertEqual(2, board[.card(.column(.archive, 0), 2)][.card(.column(.archive, 0), 2)].id)
    ...
    func testVerticalRedundant() {
        ...
        XCTAssertEqual(1, board[.card(.column(.archive, 0), 0)][.card(.column(.archive, 0), 0)].id)
        XCTAssertEqual(3, board.snaps.first!.state.actions.count)
    }
    ...
    func testVerticalRedundantUpdate() {
        ...
        board.move(.card(.column(.archive, 0), 1), vertical: 0)
        board.move(.card(.column(.archive, 0), 0), vertical: 1)
        XCTAssertEqual(1, board[.card(.column(.archive, 0), 1)][.card(.column(.archive, 0), 1)].id)
        XCTAssertTrue(board.snaps.last!.state.actions.isEmpty)
    }
    ...
    func testVerticalThenHorizontal() {
        ...
        XCTAssertEqual(1, board[.card(.column(.archive, 1), 0)][.card(.column(.archive, 1), 0)].id)
    ...
    func testMixingIndexes() {
        ...
        XCTAssertEqual(1, board[.card(.column(.archive, 2), 0)][.card(.column(.archive, 2), 0)].id)
        XCTAssertEqual(0, board[.card(.column(.archive, 1), 0)][.card(.column(.archive, 1), 0)].id)
    ...
    func testTitle() {
        board[title: .column(.archive, 0)] = "hello world"
        board[title: .column(.archive, 0)] = "lorem ipsum"
        XCTAssertEqual("lorem ipsum", board[title: .column(.archive, 0)])
        XCTAssertEqual(2, board.snaps.first!.state.actions.count)
    }
    ...
    func testDrop() {
        board[title: .column(.archive, 0)] = "Total recall"
        board.card()
        board.card()
        board[content: .card(.column(.archive, 0), 0)] = "hello world"
        board[content: .card(.column(.archive, 0), 1)] = "lorem ipsum"
        board.move(.card(.column(.archive, 0), 0), vertical: 1)
        board.move(.card(.column(.archive, 0), 0), horizontal: 1)
